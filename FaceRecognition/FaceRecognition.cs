...
namespace FaceRecognitionProject
{
    ...
    public static class FaceRecognition
    {
        ...
        {
            image = image.Resize(200, 200, Emgu.CV.CvEnum.Inter.Linear, false);//resize
            image._EqualizeHist();
        ...
        {
            Image<Gray, byte> face = source.Copy(position).Resize(200, 200, Emgu.CV.CvEnum.Inter.Linear, false);
            face._EqualizeHist();
